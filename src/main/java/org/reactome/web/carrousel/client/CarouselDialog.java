...
import org.reactome.web.carrousel.client.buttons.CarrouselButton;
...
public class CarouselDialog extends PopupPanel {
    ...
    private void initUI(int slideWidth, int slideHeight) {
        ...
        Button closeBtn = new CarrouselButton("Close this dialog", RESOURCES.getCSS().close(), new ClickHandler() {
            @Override
        ...
        carousel = new CarrouselPanel(slidesList, slideWidth, slideHeight);
    ...
    public interface ResourceCSS extends CssResource {
         ...
         */
        String CSS = "org/reactome/web/carrousel/client/CarrouselDialog.css";
