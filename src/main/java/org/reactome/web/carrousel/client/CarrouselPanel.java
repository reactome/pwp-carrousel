...
import org.reactome.web.carrousel.client.buttons.IconButton;
...
public class CarrouselPanel extends FlowPanel {
    ...
    public CarrouselPanel(List<Slide> slidesList, int slideWidth, int slideHeight) {
        this(slidesList, slideWidth, slideHeight, "transparent");
    }

    public CarrouselPanel(List<Slide> slidesList, int slideWidth, int slideHeight, String backColour) {
     ...
     */
    @CssResource.ImportedWithPrefix("diagram-CarrouselPanel")
    public interface ResourceCSS extends CssResource {
        /**
         * The path to the default CSS styles used by this resource.
         */
        String CSS = "org/reactome/web/carrousel/client/CarrouselPanel.css";
